...
<div class="flex px-10">
    <select class="bg-transparent border-solid border-2 border-gray-100  text-teal-900 rounded-[25px] outline-none focus:outline-none px-4 py-3 mt-2 w-[250px]" id="selectType">
      ...
      <input type="text" id="location"  placeholder="search by location"  class="bg-transparent border-solid border-2 border-gray-100 ml-2 text-white rounded-[25px] outline-none focus:outline-none px-4 py-3 mt-2 w-[250px]"/>
...
<div class="   slider_container pt-5">
    <div class="slider flex" id="slider" >
        ...
        <div class="infomation bg-gray-800 -mt-7 pb-5 w-screen">
